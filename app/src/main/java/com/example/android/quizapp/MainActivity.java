...
public class MainActivity extends AppCompatActivity {
    ...
    private Integer calculateScore(View view) {
        ...
        if (selectedQ3 != null) { // Selected id is null if no choice was made
            if (selectedQ3.getId() == R.id.q3_correct_option){
                score += 1;
            }
        }
        ...
        if (selectedQ5 != null) { // Selected id is null if no choice was made
            if (selectedQ5.getId() == R.id.q5_correct_option) {
                score += 1;
            }
        }
        ...
        if (selectedQ9 != null) { // Selected id is null if no choice was made
            if (selectedQ9.getId() == R.id.q9_correct_option){
                score += 1;
            }
        }
